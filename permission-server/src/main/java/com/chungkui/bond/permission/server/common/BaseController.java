package com.chungkui.bond.permission.server.common;
...
public class BaseController<T> {
    ...
    public SecurityUserInfo getLoginUser() {
        SecurityUserInfo jfUserSimple = (SecurityUserInfo) SecurityUtils.getSubject().getPrincipal();
        return jfUserSimple;
    }
